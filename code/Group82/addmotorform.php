...
<form name="AddMotor" action="uploadtoDb.php" method="POST" >
Plate Number:<input type="text" name="plate" id="plate"  required >
<br><br>
Brand:<input type="text" name="Brand" id="Brand"  required >
<br><br>
Model Year:<input type="number" name="year" id="year"  required >
<br><br>
Engine/Battery Size:<input type="number" name="engine" id="engine"  required >
<br><br>
Fuel Type:
<br>
<label><input type="radio" name="Fuel" value="Gasoline" /> Gasoline </label>
<br>
<label><input type="radio" name="Fuel" value="Diesel" /> Diesel </label>
<br>
<label><input type="radio" name="Fuel" value="Electricity" /> Electricity </label>
<br><br>
Price per 24 hours:<input type="number" name="price" id="price"  required >
<br><br>
<input type="file" name="image" required>
<br> <br>
<input type = "submit" value="Add Mororcycle" name = "AddMotor" >
</form>
